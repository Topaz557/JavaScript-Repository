...
const Calculator = {
    // this is dis playeds 0 on the screeen
    Display_Value: '0',
...
function Input_Digit(digit) {
    ...
    // we are checking to see if wait_second operarand is true and set
...
function Handle_Operator (Next_Operator) {
    ...
    //when an operator key is rpessed, we convert the current number
    // displayed on the screen to a number when store the result in
    ...
    //if operator exists, property lookup is performced for the operator
...
//this function updates the screen with the contexts of display value
